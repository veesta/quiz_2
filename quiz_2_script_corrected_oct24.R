...
#consider education as a numerical value since the numbers mean something 
...
analytic_data <- cbind(gender,age,education,neuroticism,extraversion,agreeableness)
...
analytic_data_over40 <- filter(analytic_data_male, age>40)

#View(analytic_data_over40)
